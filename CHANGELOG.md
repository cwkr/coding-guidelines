...
- Upgraded PMD to 7.15.0
- Java 17 byte code
- Deprecated rule `DefaultLabelNotLastInSwitchStmt` replaced with rule `DefaultLabelNotLastInSwitch`
- Deprecated rule `SwitchStmtsShouldHaveDefault` replaced with rule `NonExhaustiveSwitch`
